...
export const OptionDashboard = {
    layouts: {
        lg: [
          { i: 'chart-1', x: 0, y: 0, w: 8, h: 4, isBounded: true, minW: 3, name: 'Order Book', chartType: OptionsBook, isHC: false},
          { i: 'chart-2', x: 8, y: 0, w: 4, h: 4, isBounded: true, minW: 3, name: 'Order Book', chartType: ExRHC, isHC: true},
          { i: 'chart-3', x: 0, y: 2, w: 6, h: 3, isBounded: true, minW: 3, name: "Footprint Volatilty Curves", chartType: ExRHC, isHC: true},
          { i: 'chart-4', x: 6, y: 2, w: 6, h: 3, isBounded: true, minW: 3, name: "ATM Active Maturities", chartType: ExRHC, isHC: true},
          { i: 'chart-5', x: 0, y: 4, w: 6, h: 3, isBounded: true, minW: 3, name: "Shadow Skew Delta", chartType: ExRHC, isHC: true},
          { i: 'chart-6', x: 6, y: 4, w: 6, h: 3, isBounded: true, minW: 3, name: "Historical OI By Strike", chartType: ExRHC, isHC: true },
          { i: 'chart-7', x: 0, y: 6, w: 6, h: 3, isBounded: true, minW: 3, name: "USD Normalized Gamma", chartType: ExRHC, isHC: true },
          { i: 'chart-8', x: 6, y: 6, w: 6, h: 3, isBounded: true, minW: 3, name: "Gamma Level With Expiration", chartType: ExRHC, isHC: true},
        ],
        md: [
