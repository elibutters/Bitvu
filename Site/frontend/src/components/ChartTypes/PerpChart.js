      ...
      >
        <div style={{ 
          ...
          <div className="flex justify-between pt-[0.104rem] mb-[-0.2rem]">
            <div className="pr-[0.3rem] mb-[-0.2rem]">O: {legendData.open.toFixed(2)}</div>
            <div className="pr-[0.3rem] mb-[-0.2rem]">H: {legendData.high.toFixed(2)}</div>
            <div className="pr-[0.3rem] mb-[-0.2rem]">L: {legendData.low.toFixed(2)}</div>
            <div className="pr-[0.3rem] mb-[-0.2rem]">C: {legendData.close.toFixed(2)}</div>
            <div className="mb-[-0.2rem]">V: {legendData.volume.toLocaleString()}</div>
          </div>
        </div>
      </div>
